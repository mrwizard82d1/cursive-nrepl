...
goog.provide('cursive_nrepl.core_test');
goog.require('cljs.core');
goog.require('cursive_nrepl.core');
goog.require('cursive_nrepl.core');
goog.require('cemerick.cljs.test');
goog.require('cemerick.cljs.test');
cursive_nrepl.core_test.foo_test = (function foo_test(){return cemerick.cljs.test.test_function.call(null,cemerick.cljs.test.init_test_environment.call(null),cursive_nrepl.core_test.foo_test);
});
cursive_nrepl.core_test.foo_test = cljs.core.with_meta.call(null,cursive_nrepl.core_test.foo_test,cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),19,new cljs.core.Keyword(null,"end-line","end-line",1837326455),8,new cljs.core.Keyword(null,"column","column",2078222095),10,new cljs.core.Keyword(null,"line","line",212345235),8,new cljs.core.Keyword(null,"file","file",-1269645878),"C:\\cygwin\\home\\Larry\\professional\\projects\\cursive-nrepl\\test\\cljs\\cursive_nrepl\\core_test.cljs"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),cljs.core.with_meta.call(null,new cljs.core.Symbol("cursive-nrepl.core-test","foo-test","cursive-nrepl.core-test/foo-test",-1836480086,null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),19,new cljs.core.Keyword(null,"end-line","end-line",1837326455),8,new cljs.core.Keyword(null,"column","column",2078222095),10,new cljs.core.Keyword(null,"line","line",212345235),8,new cljs.core.Keyword(null,"file","file",-1269645878),"C:\\cygwin\\home\\Larry\\professional\\projects\\cursive-nrepl\\test\\cljs\\cursive_nrepl\\core_test.cljs"], null)),new cljs.core.Keyword(null,"test","test",577538877),(function foo_test_test(test_ctx__5186__auto__){var _test_ctx = test_ctx__5186__auto__;var async_QMARK___5101__auto__ = new cljs.core.Keyword(null,"async","async",1050769601).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,new cljs.core.Keyword(null,"test-name","test-name",-675595913).cljs$core$IFn$_invoke$arity$1(_test_ctx)));var _STAR_test_ctx_STAR_5361 = cemerick.cljs.test._STAR_test_ctx_STAR_;try{cemerick.cljs.test._STAR_test_ctx_STAR_ = (cljs.core.truth_(async_QMARK___5101__auto__)?null:_test_ctx);
...
try{try{var values__5121__auto___5372 = cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,cursive_nrepl.core.foo.call(null,"")),"ClojureScript!");var result__5122__auto___5373 = cljs.core.apply.call(null,cljs.core._EQ_,values__5121__auto___5372);if((result__5122__auto___5373 instanceof cemerick.cljs.test.TestContext))
...
try{try{var values__5121__auto__ = cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,cursive_nrepl.core.foo.call(null,null)),"Hello, ClojureScript!");var result__5122__auto__ = cljs.core.apply.call(null,cljs.core._EQ_,values__5121__auto__);if((result__5122__auto__ instanceof cemerick.cljs.test.TestContext))
{throw (new Error("TestContext provided as [form] in `is` assertion. If using `is` with an explicit test context, use the 3-arg arity."));
} else
{}
...
cemerick.cljs.test.register_test_BANG_.call(null,new cljs.core.Symbol(null,"cursive-nrepl.core-test","cursive-nrepl.core-test",-1784751360,null),new cljs.core.Symbol("cursive-nrepl.core-test","foo-test","cursive-nrepl.core-test/foo-test",-1836480086,null),cursive_nrepl.core_test.foo_test);
